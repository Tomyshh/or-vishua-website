  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          className="blob absolute top-0 right-0 w-64 h-64 md:w-96 md:h-96 bg-cyan-400"
          style={{ y: smoothY }}
        />
        <motion.div
          className="blob absolute bottom-0 left-0 w-64 h-64 md:w-96 md:h-96 bg-teal-400 animation-delay-2000"
          style={{ y: smoothY }}
        />
        <motion.div
          className="blob absolute top-1/2 left-1/2 w-64 h-64 md:w-96 md:h-96 bg-amber-400 animation-delay-4000"
          style={{ y: smoothY }}
        />
      </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center mb-12 md:mb-16 px-4">
            <Tilt tiltMaxAngleX={10} tiltMaxAngleY={10} scale={1.05} className="w-full sm:w-auto">
              <a
                href="/about"
                className="hero-cta group relative px-6 sm:px-8 py-3 sm:py-4 rounded-xl md:rounded-2xl bg-gradient-to-r from-cyan-500 to-teal-500 text-white font-semibold text-base sm:text-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:shadow-cyan-500/50 block w-full"
              >
                <span className="relative z-10 flex items-center justify-center gap-2">
                  גלה עוד עלינו
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 transform rtl:rotate-180 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <Tilt tiltMaxAngleX={10} tiltMaxAngleY={10} scale={1.05} className="w-full sm:w-auto">
              <button className="hero-cta group px-6 sm:px-8 py-3 sm:py-4 rounded-xl md:rounded-2xl border-2 border-cyan-500 text-cyan-600 font-semibold text-base sm:text-lg hover:bg-cyan-50 transition-all duration-300 flex items-center justify-center gap-2 w-full">
